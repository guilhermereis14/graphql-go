...
import (
	...
	"github.com/guilhermereis14/graphql-go/graph/generated"
	"github.com/guilhermereis14/graphql-go/graph/model"
)
...
func (r *courseResolver) Chapters(ctx context.Context, obj *model.Course) ([]*model.Chapter, error) {
	...
	for _, c := range r.Resolver.Chapers {
...
func (r *mutationResolver) CreateChapter(ctx context.Context, input model.NewChapter) (*model.Chapter, error) {
	...
	r.Chapers = append(r.Chapers, &chapter)
	return &chapter, nil
}
